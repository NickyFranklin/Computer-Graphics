...
void display()
{
	...
	for(int viewportID=0; viewportID<viewmat_num_viewports(); viewportID++)
	{
		...
		if(dgr_is_master())
		{
			...
			//printf("projection %f %f %f\n", identity[0], identity[5], identity[10]);
	...
	kuhl_update_model(modelgeom, 1, fmod(time,10));
